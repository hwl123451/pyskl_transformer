...
root = '/media/zjq/6CDE775EDE771F8E/lxk/NTU-data/pyskl_data/nturgb+d_skeletons/'

skeleton_files = os.listdir(root)
names = [x.split('.')[0] for x in skeleton_files]
names.sort()
missing = mrlines('/media/zjq/6CDE775EDE771F8E/lxk/video_rgbPose/tools/data/ntu120_missing.txt')
missing = set(missing)
