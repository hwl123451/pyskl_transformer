...
#     backbone=dict(
#         type='X3D',
#         in_channels=17,       # Use 17 for pose heatmap input
#         base_channels=32,        # Can be adjusted based on model size
#         gamma_w=1.0,             # Width multiplier (X3D-S)
#         gamma_b=2.25,            # Bottleneck multiplier
#         gamma_d=2.2,             # Depth multiplier
#         use_swish=True,          # Default nonlinear activation
# ),        # Keep BatchNorm trainable
#     cls_head=dict(
#         type='I3DHead',
#         in_channels=576,         # Match output channels from X3D (depends on above params)
#         num_classes=60,
#         dropout=0.5),
#     test_cfg=dict(average_clips='prob'))
